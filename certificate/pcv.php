...
{
    $font = "ARIAL.TTF";
    $image = imagecreatefrompng("pcv.png");
    $color= imagecolorallocate($image, 13, 14, 15);
    $fname= $_POST['fname'];
    $lname= $_POST['lname'];
    $name= $fname." ".$lname;
    imagettftext($image, 80, 0, 480, 2160, $color, $font, $name);
    ...
    $v="XYZ HOSPITAL";
    imagettftext($image, 65, 0, 3200, 3030, $color, $font, $v);
    $v="Director General of XYZ HOSPITAL";
